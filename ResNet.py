...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_kernels, p_planes=2, v_planes=2):
        ...
        self.conv1 = nn.Conv2d(9, 9, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        self.policyLinear = nn.Linear(64 * self.policy_planes * block.expansion, 236)
    ...
    def forward(self, x):
        ...
        out1 = F.log_softmax(self.policyLinear(out1), -1)
...
if __name__ == "__main__":
    fake = torch.tensor(np.zeros((1, 9, 8, 8)))
